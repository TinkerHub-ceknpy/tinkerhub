...
const ProfileCardComponent = ({
  avatarUrl = "https://api.dicebear.com/7.x/avataaars/svg?seed=TinkerHub",
  iconUrl = null,
  grainUrl = null,
  innerGradient,
  ...
  const cardStyle = useMemo(() => ({
    '--inner-gradient': innerGradient ?? 'linear-gradient(145deg, #1a1a1a 0%, #000000 100%)',
    '--behind-glow-color': behindGlowColor ?? 'rgba(255, 255, 255, 0.1)',
  ...
  const shineStyle = {
    ...
    backgroundImage: `
      ...
      repeating-linear-gradient(
        var(--angle),
        #ffffffff 0%,
        hsla(0, 0%, 100%, 1.00) 3.8%,
        hsla(0, 0%, 100%, 1.00) 4.5%,
        hsla(0, 0%, 100%, 1.00) 5.2%,
        #ffffffff 10%,
        #ffffffff 12%
      ),
      radial-gradient(
        farthest-corner circle at var(--pointer-x) var(--pointer-y),
        hsla(0, 0%, 100%, 0.10) 12%,
        hsla(0, 0%, 0%, 0.15) 20%,
        hsla(0, 0%, 0%, 0.25) 120%
      )
    `.replace(/\s+/g, ' '),
  ...
  const glareStyle = {
    ...
    backgroundImage: `radial-gradient(
      farthest-corner circle at var(--pointer-x) var(--pointer-y),
      hsla(0, 0%, 100%, 1.00) 12%,
      hsla(240, 2%, 11%, 0.80) 90%
    )`,
            ...
            <div
              ...
              <div
                ...
                <h3
                  ...
                  style={{
                    fontSize: '1.5rem',
                    backgroundImage: 'linear-gradient(to bottom, #ffffff, #a0a0a0)',
                ...
                <p
                  ...
                  style={{
                    ...
                    fontSize: '0.875rem',
                    margin: '0 auto',
                    backgroundImage: 'linear-gradient(to bottom, #e0e0e0, #808080)',
                    backgroundSize: '1em 1.5em',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
